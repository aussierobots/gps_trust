...
# Device type: F9P family vs F9R vs X20P
GPS_TRUST_DEVICE_TYPE_DEFAULT="${GPS_TRUST_DEVICE_TYPE:-F9P}"

read -r -p "u-blox device family [F9P/F9R/X20P] (GPS_TRUST_DEVICE_TYPE) [$GPS_TRUST_DEVICE_TYPE_DEFAULT]: " GPS_TRUST_DEVICE_TYPE_INPUT
...
ROS_DOMAIN_ID_DEFAULT="${ROS_DOMAIN_ID:-0}"
ROS_DOMAIN_ID="$(prompt_default 'ROS domain ID (ROS_DOMAIN_ID)' "$ROS_DOMAIN_ID_DEFAULT")"
